      ...
      if (weather.length > 0) {
        ...
        return (
          <div>
            ...
            <img width={100} height={100} src={country.flag} alt="Country flag"></img>
            <h2>Weather in {country.capital}</h2>
            <p>temperature: {currentWeather.temperature}° Celcius</p>
            <img width={100} height={100} src={currentWeather.weather_icons[0]} alt="Weather icon"></img>
